...
export default function PatientDashboard() {
  ...
  const upcoming = dashboard?.upcoming_appointment || null;
    ...
    <div className="space-y-8">
      <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-6">
        ...
        >
          ...
          {isLoading ? (
            ...
            <div className="serif-heading text-5xl text-[var(--textDark)] mt-2">
              {progress}% Completed
            </div>
          )}
          ...
          <div className="mt-6 h-3 rounded-full bg-white/70 overflow-hidden">
            <div
              className="h-full bg-[var(--primaryGreen)] transition-all duration-700"
          ...
          {program ? (
            <>
              ...
              <p className="mt-3 text-[var(--textSoft)]">
                {dashboard?.program_duration
                  ? `${dashboard.program_duration} Day Program`
                  : "Assigned program"}
              </p>
            </>
          ) : (
            <div className="mt-3 text-[var(--textSoft)]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        >
          ...
          <div className="serif-heading text-2xl text-[var(--textDark)] mt-2">
            {upcoming
              ? `${formatDate(upcoming.slot_at)} • ${formatTime(upcoming.slot_at)}`
